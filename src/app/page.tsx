            ...
            <div className="mt-4 flex flex-col items-center gap-3">
              <div className="relative w-full my-2">
                <div className="absolute inset-0 flex items-center">
                  <div className="w-full border-t border-muted-surface" />
                </div>
                <div className="relative flex justify-center text-[10px]">
                  <span className="bg-surface px-2.5 text-text-secondary font-medium uppercase tracking-wider">Or</span>
                </div>
              </div>
              
              <a
                href="/login"
                className="w-full bg-[#0F172A] hover:bg-[#0F172A]/90 border border-muted-surface text-white text-xs font-semibold py-3 rounded-lg shadow-subtle transition-all flex items-center justify-center gap-2.5 duration-200"
              >
