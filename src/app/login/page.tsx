          ...
          <>
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-white px-2.5 text-[#475569] font-medium">Or continue with</span>
              </div>
            </div>
            ...
            <button
              ...
              disabled={loading}
              className="w-full bg-white hover:bg-[#F8FAFC] border border-[#E2E8F0] text-xs font-semibold py-2.5 rounded-lg shadow-sm transition-all flex items-center justify-center gap-2.5 text-[#0F172A] disabled:opacity-50"
            >
